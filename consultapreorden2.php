...
<head>
    ...
    <style>
        ...
        .panel-button {
            margin-bottom: 20px; /* Espaciado antes del botón de panel de productos */
        }
    </style>
</head>
<body>
    ...
    <div class="container mt-5">
        <!-- Botón para ir al panel de productos -->
        <div class="text-center panel-button">
            <a href="panelproductos2.php" class="btn btn-success btn-space">Ir al Panel de Productos</a>
        </div>
